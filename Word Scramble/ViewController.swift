...
//  Word Scramble
//
//  Created by Bruno Lopes de Mello on 12/01/19.
...
class ViewController: UITableViewController {
    ...
    @objc func promptForAnswer() {
        ...
        let submitAction = UIAlertAction(title: "Submit",
                                         style: .default) { [unowned self, ac] (action: UIAlertAction)
                                            in
                                            let answer: UITextField = ac.textFields![0]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "Word") else { return UITableViewCell() }
